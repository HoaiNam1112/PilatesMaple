...
.caption {
  ...
  font-weight: 650;   /* đậm hơn */
  line-height: 1.5;
  z-index: 2;
  opacity: 1; /* luôn hiện chữ */
  background: none; /* không cần nền đen nữa */
}
...
.training-section.small-box {
  max-width: 1200px; 
  margin: 40px auto;  /* Thu nhỏ riêng khi thêm class small-box */
}
...
.testimonial-container {
  ...
  max-width: 800px;
  margin: 0 auto;
  height: 180px; /* hoặc chiều cao phù hợp */
  overflow: hidden;
  display: flex;
  justify-content: center;
  align-items: center;
...
.testimonial-section {
  ...
  min-height: 200px;         /* Chiều cao tối thiểu để căn giữa */
...
.center-wrapper {
  display: flex;
  justify-content: center;
  align-items: flex-start; /* Không chiếm toàn bộ chiều cao */
  padding-top: 60px;
}
